...
class TestConversationParser(unittest.TestCase):
    def test_kwarg_parser(self):
        from BlazeSudio.conversation_parse import parseKWs
    ...
    def testSummary(self):
        from BlazeSudio.conversation_parse import Summary, SL
        s = Summary('hi')
    ...
    def testKnowledge(self):
        from BlazeSudio.conversation_parse import Knowledge
